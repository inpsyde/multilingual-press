...
namespace Inpsyde\MultilingualPress\REST\Endpoint\Languages\Update;
 ...
 *
 * @package Inpsyde\MultilingualPress\REST\Endpoint\Languages\Update
 * @since   3.0.0
 */
final class RequestHandler implements Endpoint\RequestHandler {
	...
	public function handle_request( \WP_REST_Request $request ): \WP_REST_Response {
		...
		if ( ! $this->api->update_language( $id, $request->get_params() ) ) {
	...
	private function create_error_response( \WP_REST_Request $request ): \WP_REST_Response {
		...
		return $this->response_factory->create( [
			[
				...
				'message' => __( 'The language could not be updated.', 'multilingualpress' ),
