...
if ( ! class_exists( 'Mlp_Become_Inpsyder_Admin_Notice' ) ) {
	class Mlp_Become_Inpsyder_Admin_Notice {
		...
		private function render_content() {
			...
			$logo_url = plugins_url( '/assets/images/inpsyde.png',
				dirname( dirname( __FILE__ ) ) . '/multilingual-press.php' );
				...
				<p>
					...
					<a style="float: right;" href="<?php echo esc_url( $job_url ); ?>">
						<img src="<?php echo esc_url( $logo_url ); ?>"
							alt="<?php esc_attr_e( 'Work at Inpsyde', 'multilingual-press' ); ?>">
					</a>
				</p>
			</div>
			<script>
