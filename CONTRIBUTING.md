...
* If plan to work on assets, find all relevant files in the /resources folder. There you can initialize grunt with ````npm install``` and then ```grunt watch``` your changes
