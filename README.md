...
**Exciting news! MultilingualPress 3.0 is released and available for Pro users! Fully refactored, based on PHP 7, Gutenberg support, improved UI and much more. [Get 30% off on dec. 12 - Surprise in our Inpsyde Advent Calendar!](https://multilingualpress.org)**
