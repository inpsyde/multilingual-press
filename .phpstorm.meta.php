...
namespace PHPSTORM_META {
	...
	override( \Inpsyde\MultilingualPress\resolve( 0 ), map( [
		...
		'multilingualpress.post_type_repository'                  => \Inpsyde\MultilingualPress\Core\PostTypeRepository::class,
		...
		'multilingualpress.taxonomy_repository'                   => \Inpsyde\MultilingualPress\Core\TaxonomyRepository::class,
	...
	override( new \Inpsyde\MultilingualPress\Service\Container, map( [
		...
		'multilingualpress.module_settings_tab_data'                               => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageTabData::class,
		'multilingualpress.module_settings_tab_view'                               => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageView::class,
		'multilingualpress.module_settings_updater'                                => \Inpsyde\MultilingualPress\Core\Admin\ModuleSettingsUpdater::class,
		...
		'multilingualpress.plugin_settings_page_tabs'                              => 'array',
		...
		'multilingualpress.post_type_repository'                                   => \Inpsyde\MultilingualPress\Core\PostTypeRepository::class,
		'multilingualpress.post_type_settings_tab_data'                            => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageTabData::class,
		'multilingualpress.post_type_settings_tab_view'                            => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageView::class,
		'multilingualpress.post_type_settings_updater'                             => \Inpsyde\MultilingualPress\Core\Admin\PostTypeSettingsUpdater::class,
		...
		'multilingualpress.rest.languages_create_arguments'                        => \Inpsyde\MultilingualPress\REST\Common\Arguments::class,
		'multilingualpress.rest.languages_create_handler'                          => \Inpsyde\MultilingualPress\REST\Common\Endpoint\RequestHandler::class,
		'multilingualpress.rest.languages_data_filter'                             => \Inpsyde\MultilingualPress\REST\Common\Response\DataFilter::class,
		'multilingualpress.rest.languages_delete_arguments'                        => \Inpsyde\MultilingualPress\REST\Common\Arguments::class,
		'multilingualpress.rest.languages_delete_handler'                          => \Inpsyde\MultilingualPress\REST\Common\Endpoint\RequestHandler::class,
		'multilingualpress.rest.languages_formatter'                               => \Inpsyde\MultilingualPress\REST\Endpoint\Languages\Formatter::class,
		'multilingualpress.rest.languages_read_arguments'                          => \Inpsyde\MultilingualPress\REST\Common\Arguments::class,
		'multilingualpress.rest.languages_read_handler'                            => \Inpsyde\MultilingualPress\REST\Common\Endpoint\RequestHandler::class,
		'multilingualpress.rest.languages_schema'                                  => \Inpsyde\MultilingualPress\REST\Endpoint\Languages\Schema::class,
		'multilingualpress.rest.languages_update_arguments'                        => \Inpsyde\MultilingualPress\REST\Common\Arguments::class,
		'multilingualpress.rest.languages_update_handler'                          => \Inpsyde\MultilingualPress\REST\Common\Endpoint\RequestHandler::class,
		...
		'multilingualpress.rest.site_relations_formatter'                          => \Inpsyde\MultilingualPress\REST\Endpoint\SiteRelations\Formatter::class,
		...
		'multilingualpress.rest.site_relations_schema'                             => \Inpsyde\MultilingualPress\REST\Endpoint\SiteRelations\Schema::class,
		...
		'multilingualpress.save_module_settings_nonce'                             => \Inpsyde\MultilingualPress\Common\Nonce\Nonce::class,
		...
		'multilingualpress.site_settings_tab_data'                                 => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageTabDataAccess::class,
		...
		'multilingualpress.table_string_replacer'                                  => \Inpsyde\MultilingualPress\Database\TableStringReplacer::class,
		'multilingualpress.taxonomy_repository'                                    => \Inpsyde\MultilingualPress\Core\TaxonomyRepository::class,
		'multilingualpress.taxonomy_settings_tab_data'                             => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageTabData::class,
		'multilingualpress.taxonomy_settings_tab_view'                             => \Inpsyde\MultilingualPress\Common\Admin\SettingsPageView::class,
		...
		'multilingualpress.untranslated_posts_repository'                          => \Inpsyde\MultilingualPress\Widget\Dashboard\UntranslatedPosts\PostsRepository::class,
		'multilingualpress.update_post_type_settings_nonce'                        => \Inpsyde\MultilingualPress\Common\Nonce\Nonce::class,
