...
namespace PHPSTORM_META {
	...
	override( \Inpsyde\MultilingualPress\resolve( 0 ), map( [
		...
		'multilingualpress.server_request'                 => \Inpsyde\MultilingualPress\Common\Http\Request::class,
	...
	override( new \Inpsyde\MultilingualPress\Service\Container, map( [
		...
		'multilingualpress.languages'                                         => \Inpsyde\MultilingualPress\API\Languages::class,
		'multilingualpress.languages_table'                                   => \Inpsyde\MultilingualPress\Database\Table::class,
		'multilingualpress.metabox_ui_registry'                               => \Inpsyde\MultilingualPress\Common\Admin\MetaBox\MetaBoxUIRegistry::class,
		...
		'multilingualpress.post_metabox_registrar'                            => \Inpsyde\MultilingualPress\Common\Admin\MetaBox\UIAwareMetaBoxRegistrar::class,
		...
		'multilingualpress.request_globals_manipulator'                       => \Inpsyde\MultilingualPress\Common\HTTP\RequestGlobalsManipulator::class,
		'multilingualpress.server_request'                                    => \Inpsyde\MultilingualPress\Common\Http\Request::class,
