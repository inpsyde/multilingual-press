...
namespace PHPSTORM_META {
	...
	override( new \Inpsyde\MultilingualPress\Service\Container, map( [
		...
		'multilingualpress.cache_server_sitewide_driver'                           => \Inpsyde\MultilingualPress\Cache\Driver\CacheDriver::class,
		'multilingualpress.content_relations'                                      => \Inpsyde\MultilingualPress\API\ContentRelations::class,
		'multilingualpress.content_relations_table'                                => \Inpsyde\MultilingualPress\Database\Table::class,
		'multilingualpress.error_factory'                                          => \Inpsyde\MultilingualPress\Factory\ErrorFactory::class,
		...
		'multilingualpress.post_relationship_control_search'                       => \Inpsyde\MultilingualPress\Relations\Post\Search\Search::class,
		'multilingualpress.post_relationship_control_search_controller'            => \Inpsyde\MultilingualPress\Relations\Post\Search\SearchController::class,
		'multilingualpress.post_relationship_control_search_results'               => \Inpsyde\MultilingualPress\Relations\Post\Search\SearchResultsView::class,
		...
		'multilingualpress.term_relationship_permission'                           => \Inpsyde\MultilingualPress\Relations\Term\RelationshipPermission::class,
