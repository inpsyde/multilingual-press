...
class Multilingual_Press_Demo_Module extends Multilingual_Press {
	...
	public function add_settings_metabox() {
		...
		add_meta_box( 'demo_module_settings_metabox', __( 'Demo Module', $this->get_textdomain() ), array( $this, 'draw_options_page_form_fields' ), 'settings_page_mlp', 'normal', 'low', TRUE );
	}
	...
	public function draw_options_page_form_fields() {
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="demo_module[my_setting]"><?php _e( 'Label of my setting', $this->get_textdomain() ); ?></label></th>
	...
	private function module_init() {
		...
		$module_init = array(
			...
			'description'	=> __( 'This Demo Module shows developer how to use our plugin.', $this->get_textdomain() ),
		);
